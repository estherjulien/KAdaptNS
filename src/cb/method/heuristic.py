...
def algorithm(K, env, time_limit=30*60, print_info=True, problem_type="test"):
    ...
    os.makedirs("src/cb/data/results/heuristic", exist_ok=True)
    with open(f"src/cb/data/results/heuristic/final_results_{problem_type}_s{env.inst_num}.pkl", "wb") as handle:
